...
use App\Models\StatusWhat;
use App\Models\What;


class VoyagerStatusController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $documents = What::with('status')->get();
    ...
    { 
        ...
        $allCountries = Status::all();
        $document = What::find($id);
        $countriesForDocument = $document->status()->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        StatusWhat::where('what_id', $id)->delete();
