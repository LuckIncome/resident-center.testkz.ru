...
use App\Models\CitizenshipGive;
use App\Models\Give;


class VoyagerGiveController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $documents = Give::with('citizenship')->get();
    ...
    { 
        ...
        $allCountries = Citizenship::all();
        $document = Give::find($id);
        $countriesForDocument = $document->citizenship()->get();
        //dd(Status::with('what')->get());

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'countriesForDocument', 'allCountries'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        CitizenshipGive::where('give_id', $id)->delete();
        // Re-insert if there's at least one category checked
        $this->updateDocumentCountries($request, $id);
    ...
    public function create(Request $request)
    {
        ...
        $allCountries = Citizenship::all();
        $countriesForDocument = collect([]);

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allCountries', 'countriesForDocument'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->updateDocumentCountries($request, $data->id);
    ...
    protected function updateDocumentCountries(Request $request, $id)
    {        
        if ($request->country) {
            foreach ($request->country as $country) {
                CitizenshipGive::create([
                    'give_id' => $id,
